    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/reportes/platillos-por-hora/**").hasRole("ADMIN")
                .antMatchers("/api/reportes/kpis/**").hasRole("ADMIN")
                .antMatchers("/api/reportes/horas-pico/**").hasRole("ADMIN")
                .antMatchers("/api/reportes/ticket-promedio/**").hasRole("ADMIN")
                .antMatchers("/api/reportes/tendencia-mensual/**").hasRole("ADMIN")
                .antMatchers("/api/reportes/estacionalidad/**").hasRole("ADMIN")
